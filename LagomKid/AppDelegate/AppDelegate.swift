...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ////Making Auth Storyboard's Splash Screen Initial ViewController
//        let authStoryboard = UIStoryboard(name: "Auth", bundle: Bundle.main)
//        let splashVC = authStoryboard.instantiateViewController(withIdentifier: StoryboardConstants.AuthSplashScreenIdentifier)
...
//        self.window?.makeKeyAndVisible()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "LagomKid")
